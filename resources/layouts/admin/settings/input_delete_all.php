<label for="fullculqi_delete_all">
	...
	<p class="help"><?php esc_html_e( 'Only will delete the information in your WordPress, not in Culqi. Use this option when you changes from development to live mode.', 'fullculqi' ); ?></p>
